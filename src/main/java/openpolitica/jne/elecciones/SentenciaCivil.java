...
public class SentenciaCivil extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5089749091222737086L;
   ...
   */
  public static openpolitica.jne.elecciones.SentenciaCivil.Builder newBuilder() {
    return new openpolitica.jne.elecciones.SentenciaCivil.Builder();
  }
   ...
   * @return A new SentenciaCivil RecordBuilder
   */
  public static openpolitica.jne.elecciones.SentenciaCivil.Builder newBuilder(openpolitica.jne.elecciones.SentenciaCivil.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.SentenciaCivil.Builder();
    } else {
      return new openpolitica.jne.elecciones.SentenciaCivil.Builder(other);
    }
  }
   ...
   * @return A new SentenciaCivil RecordBuilder
   */
  public static openpolitica.jne.elecciones.SentenciaCivil.Builder newBuilder(openpolitica.jne.elecciones.SentenciaCivil other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.SentenciaCivil.Builder();
    } else {
      return new openpolitica.jne.elecciones.SentenciaCivil.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SentenciaCivil>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.SentenciaCivil.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.SentenciaCivil other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.materia_sentencia)) {
        this.materia_sentencia = data().deepCopy(fields()[0].schema(), other.materia_sentencia);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder setMateriaSentencia(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder clearMateriaSentencia() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder setExpedienteObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder clearExpedienteObliga() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder setOrganoJudicialObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder clearOrganoJudicialObliga() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder setFalloObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.SentenciaCivil.Builder clearFalloObliga() {
      fallo_obliga = null;

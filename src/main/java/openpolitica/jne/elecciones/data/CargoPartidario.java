...
public class CargoPartidario extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static openpolitica.jne.elecciones.data.CargoPartidario.Builder newBuilder() {
    return new openpolitica.jne.elecciones.data.CargoPartidario.Builder();
  }
   ...
   * @return A new CargoPartidario RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.CargoPartidario.Builder newBuilder(openpolitica.jne.elecciones.data.CargoPartidario.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.CargoPartidario.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.CargoPartidario.Builder(other);
    }
  }
   ...
   * @return A new CargoPartidario RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.CargoPartidario.Builder newBuilder(openpolitica.jne.elecciones.data.CargoPartidario other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.CargoPartidario.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.CargoPartidario.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CargoPartidario>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.CargoPartidario.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.CargoPartidario other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.org_politica)) {
        this.org_politica = data().deepCopy(fields()[0].schema(), other.org_politica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder setOrgPolitica(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder clearOrgPolitica() {
      org_politica = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder setCargo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder clearCargo() {
      cargo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder setAnioDesde(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder clearAnioDesde() {
      anio_desde = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder setAnioHasta(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder clearAnioHasta() {
      anio_hasta = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder setHastaActualidad(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoPartidario.Builder clearHastaActualidad() {

...
public class Experiencia extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** EXPERIENCIAS */
   private java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> laboral;
  /** CARGOELECCIONS */
   private java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> cargos_elecciones;
  /** CARGOPARTIDARIOS */
   private java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> cargos_partidarios;
  /** RENUNCIAS */
   private java.util.List<openpolitica.jne.elecciones.data.Renuncia> renuncias;
   ...
   */
  public Experiencia(java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> laboral, java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> cargos_elecciones, java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> cargos_partidarios, java.util.List<openpolitica.jne.elecciones.data.Renuncia> renuncias) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: laboral = (java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral>)value$; break;
    case 1: cargos_elecciones = (java.util.List<openpolitica.jne.elecciones.data.CargoEleccion>)value$; break;
    case 2: cargos_partidarios = (java.util.List<openpolitica.jne.elecciones.data.CargoPartidario>)value$; break;
    case 3: renuncias = (java.util.List<openpolitica.jne.elecciones.data.Renuncia>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return EXPERIENCIAS
   */
  public java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> getLaboral() {
    return laboral;
  }
   ...
   */
  public void setLaboral(java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> value) {
    this.laboral = value;
  }
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> getCargosElecciones() {
   ...
   * @param value the value to set.
   */
  public void setCargosElecciones(java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> value) {
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> getCargosPartidarios() {
   ...
   * @param value the value to set.
   */
  public void setCargosPartidarios(java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> value) {
   ...
   * @return RENUNCIAS
   */
  public java.util.List<openpolitica.jne.elecciones.data.Renuncia> getRenuncias() {
    return renuncias;
  }
   ...
   * @param value the value to set.
   */
  public void setRenuncias(java.util.List<openpolitica.jne.elecciones.data.Renuncia> value) {
   ...
   */
  public static openpolitica.jne.elecciones.data.Experiencia.Builder newBuilder() {
    return new openpolitica.jne.elecciones.data.Experiencia.Builder();
  }
   ...
   * @return A new Experiencia RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.Experiencia.Builder newBuilder(openpolitica.jne.elecciones.data.Experiencia.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.Experiencia.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.Experiencia.Builder(other);
    }
  }
   ...
   * @return A new Experiencia RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.Experiencia.Builder newBuilder(openpolitica.jne.elecciones.data.Experiencia other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.Experiencia.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.Experiencia.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Experiencia>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.Experiencia.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.Experiencia other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.laboral)) {
        this.laboral = data().deepCopy(fields()[0].schema(), other.laboral);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder setLaboral(java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder clearLaboral() {
      laboral = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder setCargosElecciones(java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder clearCargosElecciones() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder setCargosPartidarios(java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder clearCargosPartidarios() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder setRenuncias(java.util.List<openpolitica.jne.elecciones.data.Renuncia> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.Experiencia.Builder clearRenuncias() {
      renuncias = null;
    ...
    public Experiencia build() {
      try {
        ...
        record.laboral = fieldSetFlags()[0] ? this.laboral : (java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral>) defaultValue(fields()[0]);
        record.cargos_elecciones = fieldSetFlags()[1] ? this.cargos_elecciones : (java.util.List<openpolitica.jne.elecciones.data.CargoEleccion>) defaultValue(fields()[1]);
        record.cargos_partidarios = fieldSetFlags()[2] ? this.cargos_partidarios : (java.util.List<openpolitica.jne.elecciones.data.CargoPartidario>) defaultValue(fields()[2]);
        record.renuncias = fieldSetFlags()[3] ? this.renuncias : (java.util.List<openpolitica.jne.elecciones.data.Renuncia>) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (openpolitica.jne.elecciones.data.ExperienciaLaboral e0: this.laboral) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    long actualSize1 = 0;
    for (openpolitica.jne.elecciones.data.CargoEleccion e1: this.cargos_elecciones) {
      actualSize1++;
      out.startItem();
      e1.customEncode(out);
    }
    ...
    long actualSize2 = 0;
    for (openpolitica.jne.elecciones.data.CargoPartidario e2: this.cargos_partidarios) {
      actualSize2++;
      out.startItem();
      e2.customEncode(out);
    }
    ...
    long actualSize3 = 0;
    for (openpolitica.jne.elecciones.data.Renuncia e3: this.renuncias) {
      actualSize3++;
      out.startItem();
      e3.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<openpolitica.jne.elecciones.data.ExperienciaLaboral> a0 = this.laboral;
      if (a0 == null) {
        a0 = new SpecificData.Array<openpolitica.jne.elecciones.data.ExperienciaLaboral>((int)size0, SCHEMA$.getField("laboral").schema());
        this.laboral = a0;
      } else a0.clear();
      SpecificData.Array<openpolitica.jne.elecciones.data.ExperienciaLaboral> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.data.ExperienciaLaboral>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          openpolitica.jne.elecciones.data.ExperienciaLaboral e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new openpolitica.jne.elecciones.data.ExperienciaLaboral();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.data.CargoEleccion> a1 = this.cargos_elecciones;
      if (a1 == null) {
        a1 = new SpecificData.Array<openpolitica.jne.elecciones.data.CargoEleccion>((int)size1, SCHEMA$.getField("cargos_elecciones").schema());
        this.cargos_elecciones = a1;
      } else a1.clear();
      SpecificData.Array<openpolitica.jne.elecciones.data.CargoEleccion> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.data.CargoEleccion>)a1 : null);
      for ( ; 0 < size1; size1 = in.arrayNext()) {
        for ( ; size1 != 0; size1--) {
          openpolitica.jne.elecciones.data.CargoEleccion e1 = (ga1 != null ? ga1.peek() : null);
          if (e1 == null) {
            e1 = new openpolitica.jne.elecciones.data.CargoEleccion();
          }
          e1.customDecode(in);
          a1.add(e1);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.data.CargoPartidario> a2 = this.cargos_partidarios;
      if (a2 == null) {
        a2 = new SpecificData.Array<openpolitica.jne.elecciones.data.CargoPartidario>((int)size2, SCHEMA$.getField("cargos_partidarios").schema());
        this.cargos_partidarios = a2;
      } else a2.clear();
      SpecificData.Array<openpolitica.jne.elecciones.data.CargoPartidario> ga2 = (a2 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.data.CargoPartidario>)a2 : null);
      for ( ; 0 < size2; size2 = in.arrayNext()) {
        for ( ; size2 != 0; size2--) {
          openpolitica.jne.elecciones.data.CargoPartidario e2 = (ga2 != null ? ga2.peek() : null);
          if (e2 == null) {
            e2 = new openpolitica.jne.elecciones.data.CargoPartidario();
          }
          e2.customDecode(in);
          a2.add(e2);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.data.Renuncia> a3 = this.renuncias;
      if (a3 == null) {
        a3 = new SpecificData.Array<openpolitica.jne.elecciones.data.Renuncia>((int)size3, SCHEMA$.getField("renuncias").schema());
        this.renuncias = a3;
      } else a3.clear();
      SpecificData.Array<openpolitica.jne.elecciones.data.Renuncia> ga3 = (a3 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.data.Renuncia>)a3 : null);
      for ( ; 0 < size3; size3 = in.arrayNext()) {
        for ( ; size3 != 0; size3--) {
          openpolitica.jne.elecciones.data.Renuncia e3 = (ga3 != null ? ga3.peek() : null);
          if (e3 == null) {
            e3 = new openpolitica.jne.elecciones.data.Renuncia();
          }
          e3.customDecode(in);
          a3.add(e3);
        }

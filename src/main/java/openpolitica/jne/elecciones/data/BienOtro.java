...
public class BienOtro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static openpolitica.jne.elecciones.data.BienOtro.Builder newBuilder() {
    return new openpolitica.jne.elecciones.data.BienOtro.Builder();
  }
   ...
   * @return A new BienOtro RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.BienOtro.Builder newBuilder(openpolitica.jne.elecciones.data.BienOtro.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.BienOtro.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.BienOtro.Builder(other);
    }
  }
   ...
   * @return A new BienOtro RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.BienOtro.Builder newBuilder(openpolitica.jne.elecciones.data.BienOtro other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.BienOtro.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.BienOtro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BienOtro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.BienOtro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.BienOtro other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.tipo_bien)) {
        this.tipo_bien = data().deepCopy(fields()[0].schema(), other.tipo_bien);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder setTipoBien(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder clearTipoBien() {
      tipo_bien = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder setValor(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.BienOtro.Builder clearValor() {

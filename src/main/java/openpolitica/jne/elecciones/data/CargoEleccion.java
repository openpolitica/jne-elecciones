...
public class CargoEleccion extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static openpolitica.jne.elecciones.data.CargoEleccion.Builder newBuilder() {
    return new openpolitica.jne.elecciones.data.CargoEleccion.Builder();
  }
   ...
   * @return A new CargoEleccion RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.CargoEleccion.Builder newBuilder(openpolitica.jne.elecciones.data.CargoEleccion.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.CargoEleccion.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.CargoEleccion.Builder(other);
    }
  }
   ...
   * @return A new CargoEleccion RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.CargoEleccion.Builder newBuilder(openpolitica.jne.elecciones.data.CargoEleccion other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.CargoEleccion.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.CargoEleccion.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CargoEleccion>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.CargoEleccion.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.CargoEleccion other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.org_politica)) {
        this.org_politica = data().deepCopy(fields()[0].schema(), other.org_politica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder setOrgPolitica(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder clearOrgPolitica() {
      org_politica = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder setCargo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder clearCargo() {
      cargo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder setAnioDesde(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder clearAnioDesde() {
      anio_desde = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder setAnioHasta(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder clearAnioHasta() {
      anio_hasta = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder setHastaActualidad(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.CargoEleccion.Builder clearHastaActualidad() {

...
public class SentenciaCivil extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static openpolitica.jne.elecciones.data.SentenciaCivil.Builder newBuilder() {
    return new openpolitica.jne.elecciones.data.SentenciaCivil.Builder();
  }
   ...
   * @return A new SentenciaCivil RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.SentenciaCivil.Builder newBuilder(openpolitica.jne.elecciones.data.SentenciaCivil.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.SentenciaCivil.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.SentenciaCivil.Builder(other);
    }
  }
   ...
   * @return A new SentenciaCivil RecordBuilder
   */
  public static openpolitica.jne.elecciones.data.SentenciaCivil.Builder newBuilder(openpolitica.jne.elecciones.data.SentenciaCivil other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.data.SentenciaCivil.Builder();
    } else {
      return new openpolitica.jne.elecciones.data.SentenciaCivil.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SentenciaCivil>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.SentenciaCivil.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.data.SentenciaCivil other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.materia_sentencia)) {
        this.materia_sentencia = data().deepCopy(fields()[0].schema(), other.materia_sentencia);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder setMateriaSentencia(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder clearMateriaSentencia() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder setExpedienteObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder clearExpedienteObliga() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder setOrganoJudicialObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder clearOrganoJudicialObliga() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder setFalloObliga(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.data.SentenciaCivil.Builder clearFalloObliga() {
      fallo_obliga = null;

...
public class EducacionNoUniversitaria extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6090370891984853697L;
   ...
   */
  public static openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder newBuilder() {
    return new openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder();
  }
   ...
   * @return A new EducacionNoUniversitaria RecordBuilder
   */
  public static openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder newBuilder(openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder();
    } else {
      return new openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder(other);
    }
  }
   ...
   * @return A new EducacionNoUniversitaria RecordBuilder
   */
  public static openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder newBuilder(openpolitica.jne.elecciones.EducacionNoUniversitaria other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder();
    } else {
      return new openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EducacionNoUniversitaria>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.EducacionNoUniversitaria other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.centro_estudio)) {
        this.centro_estudio = data().deepCopy(fields()[0].schema(), other.centro_estudio);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder setCentroEstudio(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder clearCentroEstudio() {
      centro_estudio = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder setCarrera(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder clearCarrera() {
      carrera = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder setConcluida(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.EducacionNoUniversitaria.Builder clearConcluida() {
      concluida = null;

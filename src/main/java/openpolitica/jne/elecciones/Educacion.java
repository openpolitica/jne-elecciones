...
public class Educacion extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6181938818388039819L;
  ...
  public static Educacion fromByteBuffer(
   ...
   private openpolitica.jne.elecciones.EducacionBasica basica;
  /** EDUCACIONTECNICAS */
   private java.util.List<openpolitica.jne.elecciones.EducacionTecnica> tecnica;
  /** EDUCACIONNOUNIVERSITARIAS */
   private java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> no_universitaria;
  /** EDUCACIONUNIVERSITARIAS */
   private java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> universitaria;
  /** EDUCACIONPOSTGRADOS */
   private java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> postgrado;
   ...
   */
  public Educacion(openpolitica.jne.elecciones.EducacionBasica basica, java.util.List<openpolitica.jne.elecciones.EducacionTecnica> tecnica, java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> no_universitaria, java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> universitaria, java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> postgrado) {
    this.basica = basica;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: basica = (openpolitica.jne.elecciones.EducacionBasica)value$; break;
    case 1: tecnica = (java.util.List<openpolitica.jne.elecciones.EducacionTecnica>)value$; break;
    case 2: no_universitaria = (java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria>)value$; break;
    case 3: universitaria = (java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria>)value$; break;
    case 4: postgrado = (java.util.List<openpolitica.jne.elecciones.EducacionPostgrado>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public openpolitica.jne.elecciones.EducacionBasica getBasica() {
    return basica;
  }
   ...
   */
  public void setBasica(openpolitica.jne.elecciones.EducacionBasica value) {
    this.basica = value;
  }
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.EducacionTecnica> getTecnica() {
    return tecnica;
  }
   ...
   * @param value the value to set.
   */
  public void setTecnica(java.util.List<openpolitica.jne.elecciones.EducacionTecnica> value) {
    this.tecnica = value;
  }
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> getNoUniversitaria() {
   ...
   * @param value the value to set.
   */
  public void setNoUniversitaria(java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> value) {
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> getUniversitaria() {
   ...
   * @param value the value to set.
   */
  public void setUniversitaria(java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> value) {
   ...
   */
  public java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> getPostgrado() {
    return postgrado;
  }
   ...
   * @param value the value to set.
   */
  public void setPostgrado(java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> value) {
   ...
   */
  public static openpolitica.jne.elecciones.Educacion.Builder newBuilder() {
    return new openpolitica.jne.elecciones.Educacion.Builder();
  }
   ...
   * @return A new Educacion RecordBuilder
   */
  public static openpolitica.jne.elecciones.Educacion.Builder newBuilder(openpolitica.jne.elecciones.Educacion.Builder other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.Educacion.Builder();
    } else {
      return new openpolitica.jne.elecciones.Educacion.Builder(other);
    }
  }
   ...
   * @return A new Educacion RecordBuilder
   */
  public static openpolitica.jne.elecciones.Educacion.Builder newBuilder(openpolitica.jne.elecciones.Educacion other) {
    if (other == null) {
      return new openpolitica.jne.elecciones.Educacion.Builder();
    } else {
      return new openpolitica.jne.elecciones.Educacion.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Educacion>
    ...
    private openpolitica.jne.elecciones.EducacionBasica basica;
    private openpolitica.jne.elecciones.EducacionBasica.Builder basicaBuilder;
    /** EDUCACIONTECNICAS */
    private java.util.List<openpolitica.jne.elecciones.EducacionTecnica> tecnica;
    /** EDUCACIONNOUNIVERSITARIAS */
    private java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> no_universitaria;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.elecciones.Educacion.Builder other) {
      super(other);
      ...
      if (other.hasBasicaBuilder()) {
        this.basicaBuilder = openpolitica.jne.elecciones.EducacionBasica.newBuilder(other.getBasicaBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.elecciones.Educacion other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.basica)) {
        this.basica = data().deepCopy(fields()[0].schema(), other.basica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder setBasica(openpolitica.jne.elecciones.EducacionBasica value) {
     ...
     * @return This builder.
     */
    public openpolitica.jne.elecciones.EducacionBasica.Builder getBasicaBuilder() {
      if (basicaBuilder == null) {
        if (hasBasica()) {
          setBasicaBuilder(openpolitica.jne.elecciones.EducacionBasica.newBuilder(basica));
        } else {
          setBasicaBuilder(openpolitica.jne.elecciones.EducacionBasica.newBuilder());
        }
      }
    ...
    public openpolitica.jne.elecciones.Educacion.Builder setBasicaBuilder(openpolitica.jne.elecciones.EducacionBasica.Builder value) {
      clearBasica();
      basicaBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder clearBasica() {
      basica = null;
      basicaBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder setTecnica(java.util.List<openpolitica.jne.elecciones.EducacionTecnica> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder clearTecnica() {
      tecnica = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder setNoUniversitaria(java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder clearNoUniversitaria() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder setUniversitaria(java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder clearUniversitaria() {
      universitaria = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder setPostgrado(java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.elecciones.Educacion.Builder clearPostgrado() {
      postgrado = null;
    ...
    public Educacion build() {
      try {
        ...
        if (basicaBuilder != null) {
          ...
          record.basica = fieldSetFlags()[0] ? this.basica : (openpolitica.jne.elecciones.EducacionBasica) defaultValue(fields()[0]);
        }
        record.tecnica = fieldSetFlags()[1] ? this.tecnica : (java.util.List<openpolitica.jne.elecciones.EducacionTecnica>) defaultValue(fields()[1]);
        record.no_universitaria = fieldSetFlags()[2] ? this.no_universitaria : (java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria>) defaultValue(fields()[2]);
        record.universitaria = fieldSetFlags()[3] ? this.universitaria : (java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria>) defaultValue(fields()[3]);
        record.postgrado = fieldSetFlags()[4] ? this.postgrado : (java.util.List<openpolitica.jne.elecciones.EducacionPostgrado>) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (openpolitica.jne.elecciones.EducacionTecnica e0: this.tecnica) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    long actualSize1 = 0;
    for (openpolitica.jne.elecciones.EducacionNoUniversitaria e1: this.no_universitaria) {
      actualSize1++;
      out.startItem();
      e1.customEncode(out);
    }
    ...
    long actualSize2 = 0;
    for (openpolitica.jne.elecciones.EducacionUniversitaria e2: this.universitaria) {
      actualSize2++;
      out.startItem();
      e2.customEncode(out);
    }
    ...
    long actualSize3 = 0;
    for (openpolitica.jne.elecciones.EducacionPostgrado e3: this.postgrado) {
      actualSize3++;
      out.startItem();
      e3.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.basica == null) {
        this.basica = new openpolitica.jne.elecciones.EducacionBasica();
      }
      this.basica.customDecode(in);

      long size0 = in.readArrayStart();
      java.util.List<openpolitica.jne.elecciones.EducacionTecnica> a0 = this.tecnica;
      if (a0 == null) {
        a0 = new SpecificData.Array<openpolitica.jne.elecciones.EducacionTecnica>((int)size0, SCHEMA$.getField("tecnica").schema());
        this.tecnica = a0;
      } else a0.clear();
      SpecificData.Array<openpolitica.jne.elecciones.EducacionTecnica> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.EducacionTecnica>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          openpolitica.jne.elecciones.EducacionTecnica e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new openpolitica.jne.elecciones.EducacionTecnica();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.EducacionNoUniversitaria> a1 = this.no_universitaria;
      if (a1 == null) {
        a1 = new SpecificData.Array<openpolitica.jne.elecciones.EducacionNoUniversitaria>((int)size1, SCHEMA$.getField("no_universitaria").schema());
        this.no_universitaria = a1;
      } else a1.clear();
      SpecificData.Array<openpolitica.jne.elecciones.EducacionNoUniversitaria> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.EducacionNoUniversitaria>)a1 : null);
      for ( ; 0 < size1; size1 = in.arrayNext()) {
        for ( ; size1 != 0; size1--) {
          openpolitica.jne.elecciones.EducacionNoUniversitaria e1 = (ga1 != null ? ga1.peek() : null);
          if (e1 == null) {
            e1 = new openpolitica.jne.elecciones.EducacionNoUniversitaria();
          }
          e1.customDecode(in);
          a1.add(e1);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.EducacionUniversitaria> a2 = this.universitaria;
      if (a2 == null) {
        a2 = new SpecificData.Array<openpolitica.jne.elecciones.EducacionUniversitaria>((int)size2, SCHEMA$.getField("universitaria").schema());
        this.universitaria = a2;
      } else a2.clear();
      SpecificData.Array<openpolitica.jne.elecciones.EducacionUniversitaria> ga2 = (a2 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.EducacionUniversitaria>)a2 : null);
      for ( ; 0 < size2; size2 = in.arrayNext()) {
        for ( ; size2 != 0; size2--) {
          openpolitica.jne.elecciones.EducacionUniversitaria e2 = (ga2 != null ? ga2.peek() : null);
          if (e2 == null) {
            e2 = new openpolitica.jne.elecciones.EducacionUniversitaria();
          }
          e2.customDecode(in);
          a2.add(e2);
        }
      ...
      java.util.List<openpolitica.jne.elecciones.EducacionPostgrado> a3 = this.postgrado;
      if (a3 == null) {
        a3 = new SpecificData.Array<openpolitica.jne.elecciones.EducacionPostgrado>((int)size3, SCHEMA$.getField("postgrado").schema());
        this.postgrado = a3;
      } else a3.clear();
      SpecificData.Array<openpolitica.jne.elecciones.EducacionPostgrado> ga3 = (a3 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.elecciones.EducacionPostgrado>)a3 : null);
      for ( ; 0 < size3; size3 = in.arrayNext()) {
        for ( ; size3 != 0; size3--) {
          openpolitica.jne.elecciones.EducacionPostgrado e3 = (ga3 != null ? ga3.peek() : null);
          if (e3 == null) {
            e3 = new openpolitica.jne.elecciones.EducacionPostgrado();
          }
          e3.customDecode(in);
          a3.add(e3);
        }

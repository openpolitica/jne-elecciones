...
public class Sentencias extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Sentencias fromByteBuffer(
   ...
   private java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> sentencias_penales;
   private java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> sentencias_civiles;
   ...
   */
  public Sentencias(java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> sentencias_penales, java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> sentencias_civiles) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: sentencias_penales = (java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal>)value$; break;
    case 1: sentencias_civiles = (java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> getSentenciasPenales() {
   ...
   */
  public void setSentenciasPenales(java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> value) {
   ...
   */
  public java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> getSentenciasCiviles() {
   ...
   * @param value the value to set.
   */
  public void setSentenciasCiviles(java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> value) {
   ...
   */
  public static openpolitica.jne.plataformaelectoral.data.Sentencias.Builder newBuilder() {
    return new openpolitica.jne.plataformaelectoral.data.Sentencias.Builder();
  }
   ...
   * @return A new Sentencias RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Sentencias.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Sentencias.Builder other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Sentencias.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Sentencias.Builder(other);
    }
  }
   ...
   * @return A new Sentencias RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Sentencias.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Sentencias other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Sentencias.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Sentencias.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sentencias>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Sentencias.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Sentencias other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.sentencias_penales)) {
        this.sentencias_penales = data().deepCopy(fields()[0].schema(), other.sentencias_penales);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Sentencias.Builder setSentenciasPenales(java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Sentencias.Builder clearSentenciasPenales() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Sentencias.Builder setSentenciasCiviles(java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Sentencias.Builder clearSentenciasCiviles() {
    ...
    public Sentencias build() {
      try {
        ...
        record.sentencias_penales = fieldSetFlags()[0] ? this.sentencias_penales : (java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal>) defaultValue(fields()[0]);
        record.sentencias_civiles = fieldSetFlags()[1] ? this.sentencias_civiles : (java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil>) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (openpolitica.jne.plataformaelectoral.data.SentenciaPenal e0: this.sentencias_penales) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    long actualSize1 = 0;
    for (openpolitica.jne.plataformaelectoral.data.SentenciaCivil e1: this.sentencias_civiles) {
      actualSize1++;
      out.startItem();
      e1.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> a0 = this.sentencias_penales;
      if (a0 == null) {
        a0 = new SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaPenal>((int)size0, SCHEMA$.getField("sentencias_penales").schema());
        this.sentencias_penales = a0;
      } else a0.clear();
      SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaPenal> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaPenal>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          openpolitica.jne.plataformaelectoral.data.SentenciaPenal e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new openpolitica.jne.plataformaelectoral.data.SentenciaPenal();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
      ...
      java.util.List<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> a1 = this.sentencias_civiles;
      if (a1 == null) {
        a1 = new SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaCivil>((int)size1, SCHEMA$.getField("sentencias_civiles").schema());
        this.sentencias_civiles = a1;
      } else a1.clear();
      SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaCivil> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.plataformaelectoral.data.SentenciaCivil>)a1 : null);
      for ( ; 0 < size1; size1 = in.arrayNext()) {
        for ( ; size1 != 0; size1--) {
          openpolitica.jne.plataformaelectoral.data.SentenciaCivil e1 = (ga1 != null ? ga1.peek() : null);
          if (e1 == null) {
            e1 = new openpolitica.jne.plataformaelectoral.data.SentenciaCivil();
          }
          e1.customDecode(in);
          a1.add(e1);
        }

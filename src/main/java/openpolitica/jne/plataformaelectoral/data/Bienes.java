...
public class Bienes extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5241762795031330870L;
  ...
  /** TODO */
   private java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> bienes_otros;
  /** BIENMUEBLES */
   private java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> bienes_muebles;
  /** BIENINMUEBLES */
   private java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> bienes_inmuebles;
   ...
   */
  public Bienes(java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> bienes_otros, java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> bienes_muebles, java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> bienes_inmuebles) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: bienes_otros = (java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro>)value$; break;
    case 1: bienes_muebles = (java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble>)value$; break;
    case 2: bienes_inmuebles = (java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return TODO
   */
  public java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> getBienesOtros() {
    return bienes_otros;
  }
   ...
   */
  public void setBienesOtros(java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> value) {
   ...
   * @return BIENMUEBLES
   */
  public java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> getBienesMuebles() {
   ...
   * @param value the value to set.
   */
  public void setBienesMuebles(java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> value) {
   ...
   */
  public java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> getBienesInmuebles() {
   ...
   * @param value the value to set.
   */
  public void setBienesInmuebles(java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> value) {
   ...
   */
  public static openpolitica.jne.plataformaelectoral.data.Bienes.Builder newBuilder() {
    return new openpolitica.jne.plataformaelectoral.data.Bienes.Builder();
  }
   ...
   * @return A new Bienes RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Bienes.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Bienes.Builder other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Bienes.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Bienes.Builder(other);
    }
  }
   ...
   * @return A new Bienes RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Bienes.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Bienes other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Bienes.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Bienes.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bienes>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Bienes.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Bienes other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.bienes_otros)) {
        this.bienes_otros = data().deepCopy(fields()[0].schema(), other.bienes_otros);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder setBienesOtros(java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder clearBienesOtros() {
      bienes_otros = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder setBienesMuebles(java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder clearBienesMuebles() {
      bienes_muebles = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder setBienesInmuebles(java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Bienes.Builder clearBienesInmuebles() {
    ...
    public Bienes build() {
      try {
        ...
        record.bienes_otros = fieldSetFlags()[0] ? this.bienes_otros : (java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro>) defaultValue(fields()[0]);
        record.bienes_muebles = fieldSetFlags()[1] ? this.bienes_muebles : (java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble>) defaultValue(fields()[1]);
        record.bienes_inmuebles = fieldSetFlags()[2] ? this.bienes_inmuebles : (java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble>) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (openpolitica.jne.plataformaelectoral.data.BienOtro e0: this.bienes_otros) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    long actualSize1 = 0;
    for (openpolitica.jne.plataformaelectoral.data.BienMueble e1: this.bienes_muebles) {
      actualSize1++;
      out.startItem();
      e1.customEncode(out);
    }
    ...
    long actualSize2 = 0;
    for (openpolitica.jne.plataformaelectoral.data.BienInmueble e2: this.bienes_inmuebles) {
      actualSize2++;
      out.startItem();
      e2.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<openpolitica.jne.plataformaelectoral.data.BienOtro> a0 = this.bienes_otros;
      if (a0 == null) {
        a0 = new SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienOtro>((int)size0, SCHEMA$.getField("bienes_otros").schema());
        this.bienes_otros = a0;
      } else a0.clear();
      SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienOtro> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienOtro>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          openpolitica.jne.plataformaelectoral.data.BienOtro e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new openpolitica.jne.plataformaelectoral.data.BienOtro();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
      ...
      java.util.List<openpolitica.jne.plataformaelectoral.data.BienMueble> a1 = this.bienes_muebles;
      if (a1 == null) {
        a1 = new SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienMueble>((int)size1, SCHEMA$.getField("bienes_muebles").schema());
        this.bienes_muebles = a1;
      } else a1.clear();
      SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienMueble> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienMueble>)a1 : null);
      for ( ; 0 < size1; size1 = in.arrayNext()) {
        for ( ; size1 != 0; size1--) {
          openpolitica.jne.plataformaelectoral.data.BienMueble e1 = (ga1 != null ? ga1.peek() : null);
          if (e1 == null) {
            e1 = new openpolitica.jne.plataformaelectoral.data.BienMueble();
          }
          e1.customDecode(in);
          a1.add(e1);
        }
      ...
      java.util.List<openpolitica.jne.plataformaelectoral.data.BienInmueble> a2 = this.bienes_inmuebles;
      if (a2 == null) {
        a2 = new SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienInmueble>((int)size2, SCHEMA$.getField("bienes_inmuebles").schema());
        this.bienes_inmuebles = a2;
      } else a2.clear();
      SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienInmueble> ga2 = (a2 instanceof SpecificData.Array ? (SpecificData.Array<openpolitica.jne.plataformaelectoral.data.BienInmueble>)a2 : null);
      for ( ; 0 < size2; size2 = in.arrayNext()) {
        for ( ; size2 != 0; size2--) {
          openpolitica.jne.plataformaelectoral.data.BienInmueble e2 = (ga2 != null ? ga2.peek() : null);
          if (e2 == null) {
            e2 = new openpolitica.jne.plataformaelectoral.data.BienInmueble();
          }
          e2.customDecode(in);
          a2.add(e2);
        }

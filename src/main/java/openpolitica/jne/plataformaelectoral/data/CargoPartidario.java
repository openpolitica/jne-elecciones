...
public class CargoPartidario extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2682547655311096189L;
   ...
   */
  public static openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder newBuilder() {
    return new openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder();
  }
   ...
   * @return A new CargoPartidario RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder(other);
    }
  }
   ...
   * @return A new CargoPartidario RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.CargoPartidario other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CargoPartidario>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.CargoPartidario other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.org_politica)) {
        this.org_politica = data().deepCopy(fields()[0].schema(), other.org_politica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder setOrgPolitica(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder clearOrgPolitica() {
      org_politica = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder setCargo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder clearCargo() {
      cargo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder setAnioDesde(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder clearAnioDesde() {
      anio_desde = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder setAnioHasta(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder clearAnioHasta() {
      anio_hasta = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder setHastaActualidad(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.CargoPartidario.Builder clearHastaActualidad() {

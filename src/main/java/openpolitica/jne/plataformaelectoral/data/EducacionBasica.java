...
public class EducacionBasica extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder newBuilder() {
    return new openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder();
  }
   ...
   * @return A new EducacionBasica RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder(other);
    }
  }
   ...
   * @return A new EducacionBasica RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.EducacionBasica other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EducacionBasica>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.EducacionBasica other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.tiene_basica)) {
        this.tiene_basica = data().deepCopy(fields()[0].schema(), other.tiene_basica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder setTieneBasica(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder clearTieneBasica() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder setTienePrimaria(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder clearTienePrimaria() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder setPrimariaConcluida(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder clearPrimariaConcluida() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder setTieneSecundaria(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder clearTieneSecundaria() {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder setSecundariaConcluida(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.EducacionBasica.Builder clearSecundariaConcluida() {

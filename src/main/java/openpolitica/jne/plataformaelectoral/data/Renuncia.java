...
public class Renuncia extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5462615678054724153L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Renuncia\",\"namespace\":\"openpolitica.jne.elecciones.data\",\"fields\":[{\"name\":\"org_politica\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"anio\",\"type\":\"int\"}]}");
   ...
   */
  public static openpolitica.jne.plataformaelectoral.data.Renuncia.Builder newBuilder() {
    return new openpolitica.jne.plataformaelectoral.data.Renuncia.Builder();
  }
   ...
   * @return A new Renuncia RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Renuncia.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Renuncia.Builder other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Renuncia.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Renuncia.Builder(other);
    }
  }
   ...
   * @return A new Renuncia RecordBuilder
   */
  public static openpolitica.jne.plataformaelectoral.data.Renuncia.Builder newBuilder(openpolitica.jne.plataformaelectoral.data.Renuncia other) {
    if (other == null) {
      return new openpolitica.jne.plataformaelectoral.data.Renuncia.Builder();
    } else {
      return new openpolitica.jne.plataformaelectoral.data.Renuncia.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Renuncia>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Renuncia.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(openpolitica.jne.plataformaelectoral.data.Renuncia other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.org_politica)) {
        this.org_politica = data().deepCopy(fields()[0].schema(), other.org_politica);
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Renuncia.Builder setOrgPolitica(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Renuncia.Builder clearOrgPolitica() {
      org_politica = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Renuncia.Builder setAnio(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public openpolitica.jne.plataformaelectoral.data.Renuncia.Builder clearAnio() {
